...
export default function Hero() {
  ...
  return (
    <main className="w-full flex flex-col items-center px-6">
      {/* Hero Section */}
      <section className="w-full flex flex-col items-center justify-center gap-8 text-center pt-8">
        <motion.div
        ...
        >
          <div className="text-5xl md:text-7xl flex flex-col gap-y-2 font-black tracking-tighter max-w-5xl">
            ...
            <span className="bg-clip-text text-transparent bg-linear-to-b from-foreground to-foreground/60 text-5xl md:text-7xl">IS FINALLY EASY</span>
          </div>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl font-semibold tracking-tight">
        ...
        >
          ...
          <div
            ...
            className="group relative flex items-center justify-between gap-4 rounded-none border-2 border-border dark:border-muted-foreground/30 bg-transparent hover:bg-muted/40 px-8 py-3 text-sm cursor-pointer transition-all duration-300 "
          >
      ...
      {/* Components Section */}
      <section id="components-grid" className="w-full max-w-6xl py-20 flex flex-col gap-8">
        <div className="flex flex-col items-center gap-1">
          <h2 className="text-3xl font-bold tracking-tight">Components</h2>
          <p className="text-muted-foreground font-semibold tracking-tight text-lg">Browse the official registry of components</p>
        </div>
